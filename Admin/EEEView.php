...
$conn = connect();
$sql = "select users.*, ideas.* from ideas,users where ideas.students_id =users.id AND department_id=4";
$result = $conn->query($sql);
if($_SESSION['user_role'] ==2||$_SESSION['user_role'] ==0 || ($_SESSION['department']==4 && $_SESSION['user_role'] == 3)){ 
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading" >
                   <h1 style="text-align:center">EEE Department View</h1>
